...
SWEP.Category				= "TFA Огнестрел" --The category.  Please, just choose something generic or something I've already done if you plan on only doing like one swep..
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("AugMW.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("AugMW.FireS") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.SpreadMultiplierMax = 40 --How far the spread can expand when you shoot. Example val: 2.5
...
SWEP.AimingDownSightsSpeedMultiplier    = 5 -- Defaults to 0.8
SWEP.ProjectileVelocity = 0 --Entity to shoot's velocity
SWEP.ProjectileModel = nil --Entity to shoot's model
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/v_mw_auga3.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_aug3.mdl" -- Weapon world model path
...
SWEP.EventTable = {
	[ACT_VM_DRAW] = {
	{time = 0 / 24, type = "sound", value = Sound("AugMW.Draw")}
	},
	[ACT_VM_DRAW_DEPLOYED] = {
	{time = 0 / 24, type = "sound", value = Sound("AugMW.Draw")},
	{time = 10 / 24, type = "sound", value = Sound("AugMW.Chamber")},
	{time = 21 / 24, type = "sound", value = Sound("AugMW.DrawFoley")}
	},
	[ACT_VM_RELOAD_EMPTY] = {
		{time = 0 / 24, type = "sound", value = Sound("AugMW.Movement")},
		{time = 7 / 24, type = "sound", value = Sound("AugMW.BoltOpen")},
		{time = 19 / 24, type = "sound", value = Sound("AugMW.ClipOutCloth")},
		{time = 29 / 24, type = "sound", value = Sound("AugMW.ClipOut")},
		{time = 45 / 24, type = "sound", value = Sound("AugMW.ClipInCloth")},
		{time = 59 / 24, type = "sound", value = Sound("AugMW.ClipIn")},
		{time = 76 / 24, type = "sound", value = Sound("AugMW.Chamber")},
		{time = 85 / 24, type = "sound", value = Sound("AugMW.Rotate")}
	
	},
	[ACT_VM_RELOAD] = {
		{time = 12 / 24, type = "sound", value = Sound("AugMW.ClipIn")},
		{time = 42 / 24, type = "sound", value = Sound("AugMW.ClipOut")}
...
SWEP.VElements = {
	...
	["suppressor"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_suppressor_pistol.mdl", bone = "A_Suppressor", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0.5, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} , bonemerge = true, active = false },
...
SWEP.WElements = {
["sight_kobra"] = { type = "Model", model = "models/weapons/tfa_ins2/upgrades/a_optic_kobra.mdl", bone = "A_Optic", rel = "", pos = Vector(0, 0, 0), angle = Angle(0, 0, 0), size = Vector(0, 0, 0), color = Color(255, 255, 255, 0), surpresslightning = false, material = "", skin = 0, bodygroup = {}, active = false, bonemerge = true }
}

SWEP.Attachments = {
	[1] = {offset = { 0, 0 },atts = { "mw_augsupp"}, order = 1 },
	[3] = {offset = { 0, 0 },atts = { "ins2_ub_laser" }, order = 3 },
	[4] = {offset = { 0, 0 },atts = { "ins2_si_kobra", "ins2_si_eotech", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79", "ins2_si_po4x" }, order = 2 },
	[5] = { atts = weapon_skin_camoflauge, order = 5},
}
