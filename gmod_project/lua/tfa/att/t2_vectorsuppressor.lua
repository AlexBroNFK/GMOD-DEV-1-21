...
ATTACHMENT.Name = "Глушитель"
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = { TFA.AttachmentColors["+"], "[+] Меньше шума стрельбы", TFA.AttachmentColors["+"], "[+] -10% разброс", TFA.AttachmentColors["+"], "[+] -10% отдача", TFA.AttachmentColors["-"], "[-] -5% Урона" }ATTACHMENT.Icon = "entities/tfa_br_supp.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
