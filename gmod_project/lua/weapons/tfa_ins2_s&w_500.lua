...
SWEP.Attachments = {
	[1] = { atts = { "ins2_si_kobra", "ins2_si_rds", "ins2_si_2xrds", "ins2_si_c79", "ins2_si_mx4" }, order = 1 },
	[2] = { atts = { "ins2_ub_laser", "ins2_ub_flashlight" }, order = 2 },
	[3] = { atts = weapon_skin_camoflauge, order = 3},
}
